...
var gerarListaFilmes = function gerarListaFilmes(quantidade) {
  ...
  var status_aleatorios = ['Pendente'];
...
var AddEscala = function AddEscala(dataEscala, horaEscalaInicio, horaEscalaFim, colaboradorId) {
  ...
  $.ajax({
    ...
    url: 'http://localhost/Prj_StayFilm/escala/' + colaboradorId,
    type: 'POST',
    dataType: 'json',
    contentType: 'application/json;charset=utf-8',
    data: JSON.stringify(dados),
          ...
          $.ajax({
            ...
            response.forEach(function(colEsc) {
              ...
              colEsc.horarios.forEach(function(horario) {
                ...
                liHorariosEsc.setAttribute('class', 'aprovado');
